...
<body>
    <div class="container">
        ...
        <?php
            ...
            $query = "SELECT SUM(expenses), SUM(income) FROM `sales`";
            ...
            <div class="insights">
                ...
                <div class="sales">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h3>Общие продажи</h3>
                            <h1><?php echo $row["SUM(expenses)"] + $row["SUM(income)"].' руб.';?></h1>
                        </div>
                        <div class="progress">
                            <svg>
                    ...
                    <small class="text-muted">за прошедшие 24 часа</small>
                </div>
                <!----------------------Конец блока Продажи------------------------->
                <!----------------------Издержки------------------------->
                <div class="expenses">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h3>Издержки</h3>
                            <h1><?php echo $row["SUM(expenses)"].' руб.';?></h1>
                        </div>
                        <div class="progress">
                            <svg>
                                <circle cx="38" cy="38" r="36"></circle>
                ...
                <div class="income">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h3>Выручка</h3>
                            <h1><?php echo $row["SUM(income)"].' руб.';?></h1>
                        </div>
                        <div class="progress">
                            <svg>
                                <circle cx="38" cy="38" r="36"></circle>
